//mongo ds021671.mlab.com:21671/mongomart_mongouni -u sashoterziev -p IwftpomliM1111
...
MongoClient.connect('mongodb://sashoterziev:IwftpomliM1111@ds021671.mlab.com:21671/mongomart_mongouni', function (err, db) {
    "use strict";
        ...
        items.getCategories(function (categories) {
            ...
            items.getItems(category, page, ITEMS_PER_PAGE, function (pageItems) {
                ...
                items.getNumItems(category, function (itemCount) {
                    ...
                    //     categories.forEach(function(d){ console.log(JSON.stringify(d)); });
                    //     console.log("===============================");
                    //     console.log("Number of items found: " + itemCount);
                    //     console.log("Page items found: " + pageItems.length);
                    //     pageItems.forEach(function(d){ console.log(JSON.stringify(d)); });
                    // }
                    res.render('home', {
            ...
            items.getNumSearchItems(query, function (itemCount) {
                ...
                //Debug mode only ============================
                    if (ddebug) {
                        ...
                        console.log("===============================");
                        console.log("Number of items found: " + itemCount);
                        console.log("Search items found: " + searchItems.length);
                    }
